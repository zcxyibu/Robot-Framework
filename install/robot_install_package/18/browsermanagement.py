...
class BrowserManagementKeywords(LibraryComponent):
    ...
    @keyword
    def move_svgelement(self,locator):
        svgele = self.driver.find_element_by_xpath(locator)
        actionsvg = ActionChains(self.driver)
        actionsvg.move_to_element(svgele).perform()
    ...
    @keyword
    def click_element_perform(self, locator):
        ele = self.driver.find_element_by_xpath(locator)
        action = ActionChains(self.driver)
        action.move_to_element(ele).click().perform()

    @keyword
    def move_test(self, locator):
        return "test"
    ...
    def get_value(self, location):
        self.info("Current location is '%s'." % location)
